...
modifying the .config file in the build directory. For instance,
...
them. To simplify the configuration of single-image builds, the toplevel
...
the zephyr_library_\ API instead of the target\_* API to indirectly
modify '${IMAGE}app'.
