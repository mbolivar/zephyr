...
#
# NOTE: Usually board_set_runner_ifndef() is best in board.cmake files.
...
#
# See also board_set_flasher_ifndef() and board_set_debugger_ifndef().
macro(board_set_runner_ifndef type runner)
  _board_check_runner_type(${type})
...
# A convenience macro for board_set_runner_ifndef(FLASH ${runner}).
macro(board_set_flasher_ifndef runner)
  board_set_runner_ifndef(FLASH ${runner})
endmacro()

# A convenience macro for board_set_runner_ifndef(DEBUG ${runner}).
macro(board_set_debugger_ifndef runner)
  board_set_runner_ifndef(DEBUG ${runner})
endmacro()
