...
#
# Afterwards, the name of the library as a target can be retrieved
# with zephyr_library_target(library_name tgt). The "tgt" variable is
...
# Usage:
#   zephyr_library_target(my_zephyr_library my_var)
#   target_xyz(${my_var} ...)
#
...
function(zephyr_library_target lib_name target_var)
...
#
# New code is encouraged to use zephyr_library_target(), then the
...
#
# The function zephyr_library_target() also works for libraries
